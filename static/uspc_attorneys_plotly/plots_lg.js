...
d3.json("http://127.0.0.1:5000/api/v1.0/uspc_attorney_success_withnames/074").then(data => console.log(data));


function buildMetadata(newSample) {
    d3.json(`http://127.0.0.1:5000/api/v1.0/uspc_attorney_success_withnames/${newSample}`).then((datatiger) => {
...
function init() {
    ...
    d3.json("http://127.0.0.1:5000/api/v1.0/uspc_class_all").then((datatiger) => {
...
d3.json(`http://127.0.0.1:5000/api/v1.0/uspc_attorney_success_withnames/074`).then((datatiger) => {
