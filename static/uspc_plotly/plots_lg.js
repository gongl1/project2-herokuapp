d3.json("http://127.0.0.1:5000/api/v1.0/uspc_class_daysandrate_all").then(data => console.log(data));
...
d3.json("http://127.0.0.1:5000/api/v1.0/uspc_class_daysandrate_all").then(buildTable)
